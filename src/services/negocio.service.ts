...
//   await ensureDS();
//   await AppDataSource.getRepository(Negocio).update({ idNegocio }, { estadoAuditoria: false });
// };

// export const activar = async (idNegocio: number): Promise<void> => {
//   await ensureDS();
//   await AppDataSource.getRepository(Negocio).update({ idNegocio }, { estadoAuditoria: true });
// };
import { AppDataSource } from "../config/appdatasource";
import { Negocio } from "../entities/negocio";
import { Categoria } from "../entities/categoria";
